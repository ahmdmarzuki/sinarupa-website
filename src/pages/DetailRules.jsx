              ...
              <Banner className=" w-[70vw]">
                <div className="text-[#4A3D8F] text-justify text-lg space-y-6">
                  <section className="mt-6">
                    ...
                    <p>
                      Lomba terbuka untuk tingkat SMA, SMK, dan setara
                      se-Indonesia.
                    </p>
                  </section>
                  ...
                  <section className="mt-6">
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                      ...
                      <li>
                        Karya akhir tidak boleh melebihi dimensi <strong>30 cm x 30 cm x 1 cm</strong> di atas kanvas.
                      </li>
                    </ul>
                  </section>
                  ...
                  <section className="mt-6">
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                      <li>Pelaksanaan lomba bersifat individu dan akan berjalan secara luring (<em>offline</em>) pada Sabtu, 31 Mei 2025 di Gedung Serba Guna, ITB Jatinangor, Jl. Let. Jen. Purn. Dr. (HC) Mashudi No. 1 Jatinangor, Kab. Sumedang, Jawa Barat.</li>
